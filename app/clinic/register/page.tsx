...
export default function ClinicRegisterPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    console.log("Facility register payload:", payload);
      ...
      <div className="w-full max-w-md rounded-2xl border bg-white p-6 shadow-sm space-y-6">
        <header className="space-y-1">
          ...
          <p className="text-sm text-slate-600">
            Register your facility to post urgent needs and receive matched
            donations.
          </p>
        </header>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-rose-500"
              required
            />
          </div>
